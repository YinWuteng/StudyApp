...
public class JavaActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void findId() {
        ...
        Button btnProjectDesign = findViewById(R.id.btn_project_design);
        ...
        btnProjectDesign.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_thread_pool: //java线程
                ...
                startActivity(intent);
                break;
            case R.id.btn_project_design:
                intent.setClass(this, AlgorithmWebActivity.class);
                intent.putExtra("url", "https://github.com/YinWuteng/StudyApp/blob/master/app/src/main/java/com/study/java/project_design");
                startActivity(intent);
                break;
            default:
                break;
